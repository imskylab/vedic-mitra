...
Vedic Mitra is **dual-licensed**. You may use it under either of the following.

## 1. Open-source license — GNU AGPL-3.0-or-later

The source is available under the **GNU Affero General Public License, version 3
or later** (see [LICENSE](LICENSE)). You may use, modify, and distribute it under
those terms. Importantly, the AGPL requires that if you distribute the app **or
make it available to users over a network** (for example, as a hosted service),
...
closed-source** product, or you otherwise cannot or do not wish to comply with
...
Vedic Mitra builds on third-party open-source components under their own
licenses; see [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md).

---

*This document is a plain-language summary and is not legal advice. The
[LICENSE](LICENSE) file is the authoritative AGPL text; commercial-license terms
are provided separately in writing.*
